...
![count after changed type of join](https://github.com/oslippy/goit-rdb-hw-04/blob/main/Screenshot%202026-04-06%20at%2020.18.18.png)
    ...
    Кількість рядків не змінилась бо дані в CSV (які ми завантажували у БД) чисті та узгоджені — кожен customer_id 
    в orders має відповідний запис у customers, кожен supplier_id у products є в suppliers тощо. 
    Кількість рядків змінилась би, якби, наприклад:
